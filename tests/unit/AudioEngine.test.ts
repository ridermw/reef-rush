...
class FakeGain extends FakeNode implements AudioGainPort {
  gain = new FakeParam();
}

class FakeOscillator extends FakeNode implements AudioOscillatorPort {
...
class FakeContext implements AudioContextPort {
  ...
  closeGate: ReturnType<typeof deferred> | null = null;
